	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"rgba(255, 255, 255, 1)","headFontSize":"20px","headUserInfoFontColor":"#333","headBoxShadow":"0 1px 0px rgba(255,255,255, 1)","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"#3B7A57","headFontColor":"#000","headTitleImg":false,"headHeight":"62px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"#6BBB7D","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"#333","headUserInfoFontSize":"18px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"18px"},
			};
		},
		created() {
			this.setHeaderStyle()
